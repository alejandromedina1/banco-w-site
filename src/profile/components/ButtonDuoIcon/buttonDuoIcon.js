...
class ButtonDuoIcon extends HTMLElement {
  ...
  static get observedAttributes() {
    return ["text", "icon", "additional_text", "link"];
  }
  ...
  render() {
    ...
    <button type="button" class="buttonDuoIcon">
        ...
        <div class="buttonDuoIcon__text-container" style="flex-direction: ${
          additionalText ? "column" : "row"
        };align-items: ${additionalText ? "start" : "center"}">
        <span class="buttonDuoIcon__text">${this.text}</span>
        <span class="buttonDuoIcon__additional-text" style="display: ${
          additionalText ? "block" : "none"
        }">${additionalText}</span>
        </div>
